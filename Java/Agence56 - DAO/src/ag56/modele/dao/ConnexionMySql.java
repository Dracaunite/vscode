...
public class ConnexionMySql { // DAO = Data Access Object
	 ...
	 * pour utiliser cette méthode : ConnexionMySql.connecterBd()
	 */
	public static void connecterBd(){
		//connexion à la base de donnée à partir de jdbc
		String url = "jdbc:mysql://192.179.1.12:3306/Agence56"; // url : chaine de connexion
	 ...
	 * pour utiliser cette méthode: ConnexionMySql.execReqSelection(uneRequete) où uneRequête est de type String
	 */
	public static ResultSet execReqSelection(String laRequete){ 
		...
		catch(Exception e) { System.out.println("Erreur de requête : " + laRequete); }
		return resultatReq;	
	}
	 ...
	 * pour utiliser cette méthode : ConnexionMySql.execReqMaj(uneRequete) où uneRequête est de type String
	 */
	 ...
	 * pour utiliser cette méthode : ConnexionMySql.fermerConnexionBd()
	 */
